...
('lead_welcome_wa', 'whatsapp', NULL,
 'Olá {{name}}! 👋 Vi que você se interessou pelo Dossiê do Futuro Franqueado. Seu link para finalizar: {{link}}',
 'Mensagem imediata ao capturar lead'),
('recovery_5min_wa', 'whatsapp', NULL,
 'Oi {{name}}, notei que você não finalizou sua compra. Aqui está seu link: {{link}} — qualquer dúvida me chama!',
 'Recuperação 5 minutos após abandono'),
('recovery_24h_wa', 'whatsapp', NULL,
 'Olá {{name}}! Já são mais de 327 pessoas usando o Dossiê para tomar a decisão certa antes de investir em uma franquia. Você ainda pode garantir o seu: {{link}}',
 'Recuperação 24h com prova social'),
('recovery_7d_wa', 'whatsapp', NULL,
 'Oi {{name}}! Liberei um cupom de 5% OFF só para você: BIZGUARDIAN5. Use no checkout: {{link}} — válido até amanhã.',
 'Recuperação 7 dias com cupom'),
('postvenda_wa', 'whatsapp', NULL,
 'Bem-vindo {{name}}! 🎉 Sua compra do {{product}} foi confirmada. Acesse a área do membro: https://marinhoponci.com/membro/login — login: {{email}}. Para sua reunião bônus de 30 min, agende em: https://cal.com/marinhoponci',
