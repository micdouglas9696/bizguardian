                    ...
                    <div className="max-w-[1700px] mx-auto grid lg:grid-cols-12 min-h-[700px] relative gap-0">
                        ...
                        <div className="lg:col-span-7 relative z-30 p-5 sm:p-8 md:p-16 lg:p-24 flex flex-col justify-center items-center sm:items-start text-center sm:text-left">
                            ...
                            <div className="mt-5 sm:mt-6 w-full flex justify-end">
                                <img src="/2.webp" alt="Assinatura Marinho Ponci" width="300" height="195" className="h-10 sm:h-12 w-auto object-contain opacity-70" />
                            </div>
                    ...
                    <section className="mb-12 relative w-full section-reveal" id="ecossistema">
                        <div className="max-w-[1700px] mx-auto px-6 md:px-12 grid lg:grid-cols-12 gap-16 items-center">
                            <div className="lg:col-span-5 relative z-20 flex flex-col items-center sm:items-start text-center sm:text-left">
                                ...
                                <div className="pt-12 text-center sm:text-left w-full">
                                    <div className="inline-block border-t border-white/10 pt-8 mt-4 max-w-full">
                                        <span className="text-2xl sm:text-3xl font-black text-white block mb-1 leading-snug">🇵🇹 🇪🇸 🇦🇹 🇺🇸 🇧🇷</span>
                                ...
                                {[
                                    ...
                                    >
                                        <img
                                            ...
                                            src={`/${item.image.replace(/\.(png|jpg)$/, '.webp')}`}
                                        />
                            ...
                            <div className="relative z-10 grid lg:grid-cols-2 gap-16 lg:gap-32 items-start">
                                ...
                                <form className="space-y-5" onSubmit={async (e) => {
                                    ...
                                    {contactSuccess ? (
                                        ...
                                        <>
                                            <label htmlFor="contact-service-select" className="sr-only">Serviço de interesse</label>
                                            <select
                ...
                <div className="max-w-[1700px] mx-auto px-6 md:px-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24 mb-16">
                        ...
                        <div className="flex flex-col items-start">
                            <img src="/marinho final.webp" alt="Marinho Ponci Logo" width="400" height="144" className="h-12 w-auto object-contain mb-8" />
                            ...
                            <div className="flex flex-wrap gap-4">
                                <a href="https://www.linkedin.com/in/marinhoponci/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn de Marinho Ponci" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all text-white/60">
                                ...
                                <a href="https://www.youtube.com/channel/UCGNCj2ncXuC_-Iz0znRbyPA" target="_blank" rel="noopener noreferrer" aria-label="YouTube de Marinho Ponci" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all text-white/60">
                                ...
                                <a href="https://open.spotify.com/user/12159463678?si=7db287e2ae3d4f12" target="_blank" rel="noopener noreferrer" aria-label="Spotify de Marinho Ponci" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all text-white/60">
                                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2zm.12-3.36C15.24 8.4 8.82 8.16 5.16 9.301c-.6.179-1.2-.181-1.38-.721-.18-.601.18-1.2.72-1.381 4.26-1.26 11.28-1.02 15.721 1.621.539.3.719 1.02.419 1.56-.299.421-1.02.599-1.559.3z" /></svg>
                                </a>
                                <a href="https://www.instagram.com/marinhoponci/" target="_blank" rel="noopener noreferrer" aria-label="Instagram de Marinho Ponci" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all text-white/60">
                                ...
                                <a href="https://www.facebook.com/marinho.ponci/?locale=pt_PT" target="_blank" rel="noopener noreferrer" aria-label="Facebook de Marinho Ponci" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all text-white/60">
                        ...
                        <div className="flex gap-16 lg:justify-center">
                            <div>
                                <p className="text-white font-black uppercase tracking-[0.2em] text-[10px] mb-6" role="heading" aria-level={3}>Navegação</p>
                                <div className="flex flex-col gap-4">
                                    {['Sobre', 'Ecossistema', 'Internacionalize-se'].map((item) => (
                                        <a key={item} href={`#${item.toLowerCase()}`} className="text-[11px] font-bold uppercase tracking-widest text-white/60 hover:text-accent-gold transition-all">
                                            {item}
                                        </a>
                                    ))}
                            ...
                            <div>
                                <p className="text-white font-black uppercase tracking-[0.2em] text-[10px] mb-6" role="heading" aria-level={3}>Legal</p>
                                <div className="flex flex-col gap-4">
                                    {['Privacidade', 'Termos', 'Compliance'].map((item) => (
                                        <a key={item} href="#" className="text-[11px] font-bold uppercase tracking-widest text-white/60 hover:text-accent-gold transition-all">
                                            {item}
                                        </a>
                                    ))}
                                </div>
                        ...
                        <div className="flex flex-col md:items-end md:text-right">
                            <p className="text-white font-black uppercase tracking-[0.2em] text-[10px] mb-6" role="heading" aria-level={3}>Contato Direto</p>
                            ...
                            <p className="text-white/70 text-sm leading-relaxed max-w-xs md:max-w-[200px]">
                    ...
                    <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
                        <p className="text-[9px] font-black uppercase tracking-[0.5em] text-white/60 text-center md:text-left">
                            © 2026 MARINHO PONCI. ALL RIGHTS RESERVED. BORN FOR GLOBAL.
                        </p>
                        <p className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 text-center md:text-right">
                            Desenvolvido por{' '}
                            <a
                                href="https://mycom.dev.br"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-white/60 hover:text-accent-gold transition-colors duration-300"
                            >
                                Mycom
                            </a>
                        </p>
