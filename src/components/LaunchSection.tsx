                            ...
                            <div className="bg-zinc-900/40 border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-xl relative overflow-hidden group hover:border-accent-gold/30 transition-all duration-700 shadow-2xl">
                                ...
                                <div className="flex items-center gap-8">
                                    <button
                                        ...
                                        className="px-10 py-5 bg-white text-black text-[10px] font-black uppercase tracking-[0.4em] hover:bg-accent-gold hover:text-white transition-all shadow-glow-primary rounded-lg"
                                    >
                                        Garantir Minha Vaga
                                    </button>
